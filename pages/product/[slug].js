                ...
                <div className="lg:w-4/5 mx-auto flex flex-wrap justify-center items-center">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <button onClick={()=>{addToCart(slug, 1, 499, "Bathroom Cleaning Spray")}} className="flex ml-4 text-white bg-red-500 border-0 py-2 px-2 md:px-2 focus:outline-none hover:bg-red-600 rounded">Add to Cart</button>
