...
const Footer = () => {
    return (
        <footer className="text-gray-600 bg-gray-200 body-font mb-12">
                ...
                <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Hand wash</a>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Shammpoo</a>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Cleaner</a>
                            </li>
                            <li>
                                <a className="text-gray-600 hover:text-gray-800">Perfume</a>
                            </li>
                        </nav>
                    </div>
                    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <div className="bg-gray-300">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 Clox.com — All Rights Reserved</p>
